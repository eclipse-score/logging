...
#ifndef SCORE_MW_LOG_DETAIL_DATA_ROUTER_SHARED_MEMORY_COMMON_H
#define SCORE_MW_LOG_DETAIL_DATA_ROUTER_SHARED_MEMORY_COMMON_H
...
#endif  // SCORE_MW_LOG_DETAIL_DATA_ROUTER_SHARED_MEMORY_COMMON_H
