...
{
  public:
    MOCK_METHOD(std::string, GetString, (const std::string& key, const std::string& default_value), (override final));
    MOCK_METHOD(bool, GetBool, (const std::string& key, const bool default_value), (override final));
