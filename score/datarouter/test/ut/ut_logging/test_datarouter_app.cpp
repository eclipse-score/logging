...
{
  protected:
    // We'll keep an atomic_bool to pass to DatarouterAppRun()
...
TEST_F(DatarouterAppTest, AppInit)
{
    ...
    EXPECT_NO_FATAL_FAILURE(score::logging::datarouter::DatarouterAppInit());
}
...
TEST_F(DatarouterAppTest, AppRunNoAdaptiveRuntime)
{
    ...
    EXPECT_NO_FATAL_FAILURE(score::logging::datarouter::DatarouterAppRun(exit_requested_));
}
...
TEST_F(DatarouterAppTest, AppRunPrintVersion)
{
    ...
    score::logging::datarouter::DatarouterAppRun(exit_requested_);
...
TEST_F(DatarouterAppTest, AppShutdown)
{
    ...
    EXPECT_NO_FATAL_FAILURE(score::logging::datarouter::DatarouterAppShutdown());
}
