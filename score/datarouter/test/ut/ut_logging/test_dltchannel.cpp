...
TEST_F(DltChannelTest, WhenCreatedDefault)
{
    ...
    DltLogChannel dlt_channel(
        DltidT{"CHN0"}, score::mw::log::LogLevel::kOff, DltidT{"ECU0"}, nullptr, 3491U, nullptr, 3490U, "");
}
...
TEST_F(DltChannelTest, WhenSendingFTVerboseHitsSleepCondition)
{
    ...
    DltLogChannel dlt_channel(DltidT{"CHN0"}, log_level, DltidT{"ECU0"}, nullptr, 3491U, nullptr, 3490U, "");
