...
.. _component_architecture_datarouter:

Datarouter Component Architecture
=================================

..
   TEMPLATE: Uncomment and customize the document directive:
...
.. comp:: datarouter
   ...
   :safety: ASIL_B
   :status: invalid
   :uses: logic_arc_int__logging__buffer
