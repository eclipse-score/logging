...
.. _component_architecture_log_bridge:

Log Bridge Component Architecture
=================================

.. document:: log_bridge Architecture
   :id: doc__log_bridge_architecture
   :status: draft
   :safety: ASIL_B
   :security: NO
...
.. comp:: log_bridge
   ...
   :safety: ASIL_B
   :status: invalid
   :implements: logic_arc_int__log_rust__score_logger
   :uses: logic_arc_int__log_cpp__recorder
