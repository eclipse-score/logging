...
.. document:: Logging Safety WPs
   :id: doc__logging_safety_wp
   :status: draft
   :version: 1
   :safety: ASIL_B
   :security: NO
...
.. list-table:: Feature Logging Work products
    :header-rows: 1
    ...
    * - :need:`wp__sw_arch_verification`
      ...
      - :need:`doc__logging_arc_inspection`
...
.. needtable::
   :filter: docname is not None and "logging" in docname and "requirements" in docname
   :style: table
   :types: feat_req
   :tags: logging
   :columns: id;status
...
.. needtable::
   :filter: docname is not None and "logging" in docname and "architecture" in docname
   :style: table
