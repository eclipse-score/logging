...
.. _component_architecture_recorders:

recorders Component Architecture
================================

.. document:: recorders Architecture
   :id: doc__recorders_architecture
   :status: draft
   :safety: ASIL_B
   :security: NO
...
.. comp:: recorders
   ...
   :safety: ASIL_B
   :status: invalid
   :consists_of: comp__data_router_recorder, comp__file_recorder
...
..
   ...
   .. comp_arc_sta:: recorders (Static View)
      :id: comp_arc_sta__recorders__static_view
      :security: YES
      :safety: ASIL_B
      :status: invalid
